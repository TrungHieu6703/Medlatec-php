...
<body>
    <nav class="navbar navbar-expand-lg navbar-info bg-info" style="width: 100%; position: fixed; z-index: 99;">
        <h5 class="text-white"><a href="index.php" style="text-decoration: none; color: white;">Trang Chủ</a></h5>
